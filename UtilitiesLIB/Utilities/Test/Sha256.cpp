...
BOOST_AUTO_TEST_CASE(sha256)
{
  ...
  BOOST_CHECK_EQUAL(
    utils::sha256("test"), "9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08");
  BOOST_CHECK_EQUAL(
    utils::sha256("alskdj"), "a343e3cbcc72928a571778f77bf2554eb5b72c79ce28bbc9d3325c60c21e5241");
  BOOST_CHECK_EQUAL(utils::sha256("symbol=LTCBTC&side=BUY&type=LIMIT&timeInForce=GTC&quantity=1&"
...
BOOST_AUTO_TEST_CASE(hmacSha256)
{
  ...
  BOOST_CHECK_EQUAL(utils::hmacSha256("sample message", "12345"),
                    "ee40ca7bc90df844d2f5b5667b27361a2350fad99352d8a6ce061c69e41e5d32");
  // From binance api docs example
  BOOST_CHECK_EQUAL(
    utils::hmacSha256("symbol=LTCBTC&side=BUY&type=LIMIT&timeInForce=GTC&quantity=1&price=0.1&"
